...
export const types = [
  { label: "Lycoperdon - אבקית" },
  { label: "Suillus - אורנייה" },
  { label: "Auricularia - אזנונית" },
  { label: "Lepista - אחלמית" },
  { label: "Ganoderma - בהוקית" },
  { label: "Cantharellus - גביעונית" },
  { label: "Gymnopilus - גידמית" },
  { label: "Coprinus - דיואית" },
  { label: "Coprinellus - דיואית" },
  { label: "Coprinopsis - דיואית" },
  { label: "Gloeophyllum - דפדפנית" },
  { label: "Crepidotus - דרדסית" },
  { label: "Symocibe - דרדסית" },
  { label: "Hystrerangium - היסטרית" },
  { label: "Terena - יפענית" },
  { label: "Bovista - כדורנית" },
  { label: "Calvatia -	כדורית" },
  { label: "Galerina - כומתית" },
  { label: "Battarrea - כלונסית" },
  { label: "Macowanites - כרסנית" },
  { label: "Flammulina - להבית" },
  { label: "Hygrocybe - לחית" },
  { label: "Chuphophyllus - לחית" },
  { label: "Macrolepiota - מיטרנית" },
  { label: "Cyathus - מצילה" },
  { label: "Agrocybe - נירנית" },
  { label: "Cyclocybe - נירנית" },
  { label: "Polyporus - נקבובנית" },
  { label: "Cerioporus - נקבובנית" },
  { label: "Lactarius - נטופה" },
  { label: "Podaix - סדנית" },
  { label: "Scleroderma - עורית" },
  { label: "Disciseda - פחוסית" },
  { label: "Mycena - פטרה" },
  { label: "Atheniella - פטרה" },
  { label: "Hemimycena - פטרה" },
  { label: "Vascellum - פרגודית" },
  { label: "Hymenopellis - צמדית" },
  { label: "Tremella - קרישית" },
  { label: "Psathyrella - שברירית" },
  { label: "Hydronocybe - שלחופית" },
];
